...
app.use((req, res, next) => {
    ...
    res.setHeader('Access-Control-Allow-Credentials', 'true'); // Set to 'true' if your requests include credentials
    next();
});
...
app.listen(7001, () => {
    ...
    console.log('fMONGODB_CONNECTION_STRING', process.env.MONGODB_CONNECTION_STRING);
